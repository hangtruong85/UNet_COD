...
class EvalConfig:
    ...
    def __init__(self):
        # Model to evaluate
        self.model_name = "UNetPP_DCNv4_COD"
        
        # Checkpoint path
        self.ckpt_path = "logs/UNetPP_DCNv4_COD_20251215_155510/best_s_measure.pth"
...
def compare_models():
    """
    Evaluate and compare multiple DCN versions
    """
    models_to_compare = [
    ...
    for model_name, ckpt_path in models_to_compare:
        ...
        for key in ['S_mean', 'E_mean', 'F_mean', 'MAE_mean']:
    ...
    print("COMPARISON TABLE")
    print("="*80)
    print(f"{'Model':<25} {'S-measure':<12} {'E-measure':<12} {'F-measure':<12} {'MAE':<12}")
    print("-"*80)
