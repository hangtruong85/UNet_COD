...
Variants: UNet (baseline), UNet_B3 (EfficientNet-B3), UNet_BEM (with Boundary Enhancement)
"""
...
class UNet(nn.Module):
    """
    Basic UNet with timm-efficientnet-b3 encoder
    """
...
if __name__ == "__main__":
    ...
    for name, ModelClass in [("UNet", UNet), ("UNet_B3", UNet_B3), ("UNet_BEM", UNet_BEM)]:
